...
**抽象表示-例如：链表中的每一个结点就是数据元素，结点中的某个变量就是数据项。相同结构的结点的集合就是数据对象（加上数据元素（结点）的关系就是数据结构链表）。有限个不同结构的数据对象组成数据。**
...
![image-20250903102327506](1.assets/image-20250903102327506.png)

![image-20250903102818645](1.assets/image-20250903102818645.png)

![image-20250903102840575](1.assets/image-20250903102840575.png)

![image-20250903102929713](1.assets/image-20250903102929713.png)

![image-20250903110727947](1.assets/image-20250903110727947.png)
...
![image-20250903173250113](1.assets/image-20250903173250113.png)

**频度即次数。**

![image-20250903172455565](1.assets/image-20250903172455565.png)

![image-20250903172519336](1.assets/image-20250903172519336.png)

![image-20250903172702279](1.assets/image-20250903172702279.png)

![image-20250903172726048](1.assets/image-20250903172726048.png)

![image-20250903172742892](1.assets/image-20250903172742892.png)

![image-20250903172830379](1.assets/image-20250903172830379.png)

![image-20250903171812716](1.assets/image-20250903171812716.png)
...
![image-20250904150102761](1.assets/image-20250904150102761.png)

![image-20250904150112167](1.assets/image-20250904150112167.png)

![image-20250904150148824](1.assets/image-20250904150148824.png)

![image-20250904150226306](1.assets/image-20250904150226306.png)

![image-20250904150256029](1.assets/image-20250904150256029.png)

## 2.2、案例引入

![image-20250904150330969](1.assets/image-20250904150330969.png)

![image-20250904150403139](1.assets/image-20250904150403139.png)

![image-20250904150415892](1.assets/image-20250904150415892.png)

![image-20250904150427378](1.assets/image-20250904150427378.png)

![image-20250904150513946](1.assets/image-20250904150513946.png)

![image-20250904150551242](1.assets/image-20250904150551242.png)

![image-20250904150612469](1.assets/image-20250904150612469.png)

![image-20250904150626562](1.assets/image-20250904150626562.png)

![image-20250904150655105](1.assets/image-20250904150655105.png)

![image-20250904150707925](1.assets/image-20250904150707925.png)

![image-20250904150726614](1.assets/image-20250904150726614.png)
...
![image-20250904150817614](1.assets/image-20250904150817614.png)

![image-20250904152803997](1.assets/image-20250904152803997.png)

![image-20250904152830835](1.assets/image-20250904152830835.png)

![image-20250904152857782](1.assets/image-20250904152857782.png)

![image-20250904152918534](1.assets/image-20250904152918534.png)

![image-20250904152945716](1.assets/image-20250904152945716.png)

![image-20250904153013720](1.assets/image-20250904153013720.png)

![image-20250904153049911](1.assets/image-20250904153049911.png)
...
顺序存储表示：用一组**地址连续**的存储单元依次存储线性表的数据元素的方式，具有顺序存储结构的特点（**数据间的逻辑关系和物理关系是一致的：逻辑上相邻，物理上依旧相邻**）

![image-20250904153343751](1.assets/image-20250904153343751.png)

![image-20250904154825684](1.assets/image-20250904154825684.png)
...
![image-20250904155602799](1.assets/image-20250904155602799.png)

![image-20250904160307010](1.assets/image-20250904160307010.png)
...
![image-20250904160504707](1.assets/image-20250904160504707.png)
...
![image-20250904163144955](1.assets/image-20250904163144955.png)
...
| 内存位置     | 栈       | 堆                  |
| 大小确定时间 | 编译时   | 运行时              |
| 大小可变性   | 固定     | 可变（通过realloc） |
| 内存管理     | 自动     | 手动（malloc/free） |
| 访问速度     | 较快     | 稍慢（指针访问）    |
| 内存效率     | 高       | 略低（有指针开销）  |

![image-20250904163446569](1.assets/image-20250904163446569.png)

**显然内存的基本操作单位是字节。**

![image-20250904164404783](1.assets/image-20250904164404783.png)

#### 2.4.1.2 值传递，引用传递和指针传递

![image-20250904164724246](1.assets/image-20250904164724246.png)

![image-20250904165700792](1.assets/image-20250904165700792.png)

![image-20250904165815170](1.assets/image-20250904165815170.png)

![image-20250904170049411](1.assets/image-20250904170049411.png)

![image-20250904170325215](1.assets/image-20250904170325215.png)

![image-20250904170342143](1.assets/image-20250904170342143.png)

![image-20250904170424317](1.assets/image-20250904170424317.png)

![image-20250904170453845](1.assets/image-20250904170453845.png)

![image-20250904170758565](1.assets/image-20250904170758565.png)

| 特性     | 引用               | 指针             |
| -------- | ------------------ | ---------------- |
| 初始化   | 必须在声明时初始化 | 可以延迟初始化   |
| 重新赋值 | 不能重新绑定       | 可以指向不同对象 |
| 空值     | 不存在空引用       | 可以是nullptr    |
| 算术运算 | 不支持             | 支持算术运算     |
| 间接访问 | 直接访问           | 需要解引用(*)    |

![image-20250904171808933](1.assets/image-20250904171808933.png)

### 2.4.2、顺序表中基本操作的实现

![image-20250905111743332](1.assets/image-20250905111743332.png)

![image-20250905112116196](1.assets/image-20250905112116196.png)

![image-20250906161209717](1.assets/image-20250906161209717.png)

![image-20250906162203325](1.assets/image-20250906162203325.png)

![image-20250906162321414](1.assets/image-20250906162321414.png)

**一、顺序表初始化**

![image-20250906161733933](1.assets/image-20250906161733933.png)
...
![image-20250906162756639](1.assets/image-20250906162756639.png)
...
![image-20250906162932090](1.assets/image-20250906162932090.png)

![image-20250906163304744](1.assets/image-20250906163304744.png)

![image-20250908140851955](1.assets/image-20250908140851955.png)

![image-20250908143911017](1.assets/image-20250908143911017.png)

![image-20250908144038286](1.assets/image-20250908144038286.png)

![image-20250908161716910](1.assets/image-20250908161716910.png)
...
![image-20250908162719689](1.assets/image-20250908162719689.png)

![image-20250908163833945](1.assets/image-20250908163833945.png)

![image-20250908164349923](1.assets/image-20250908164349923.png)

![image-20250908165512228](1.assets/image-20250908165512228.png)
